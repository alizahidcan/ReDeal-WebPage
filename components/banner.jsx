                ...
                <div className="mx-auto grid grid-cols-1 md:grid-cols-3 max-w-7xl px-4 sm:px-6 md:px-8">
                    <div className="col-span-1">
                        ...
                        <a
                            id='bannerBtn'
                            href="#"
                            className="inline-block mt-8 rounded-xl border border-transparent px-8 py-3 text-center font-medium text-white"
                            >
                            Try Deal Analyzer Now
                        </a>
                        <Image src="/vector.svg" width={120} height={30} className='inline pl-10 pt-5 md:pt-10'/>
                    </div>
                    <div id='bannerPicture' className='col-span-1 md:col-span-2 relative left-5 md:left-64 bg-no-repeat bg-contain mt-10 sm:mt-0'>
                        <div id='firstCollap' className='bg-white w-44 h-56 relative right-3 bottom-5 md:right-12'>
                        ...
                        <div id='secCollap' className='relative right-3 top-16 md:right-12 md:top-40'>
                            <p>Valuation</p>
                            <h1>$8944900</h1>
                            <Image src="/graph.svg" width={80} height={30}/>
                        </div>
                        <div id='thirdCollap' className='relative top-16 md:right-4 md:top-40'>
